<?php $__env->startSection('title', 'Digital Document Signing - QR Drag & Drop'); ?>
...
<div class="signing-container">
    ...
    <div class="qr-code-section">
        ...
        <div class="qr-code-wrapper" id="qrCodeWrapper">
            <?php if($documentSignature && $documentSignature->temporary_qr_code_path): ?>
                <div class="qr-code-item" id="qrCodeItem" draggable="true">
                    <img src="<?php echo e(Storage::url($documentSignature->temporary_qr_code_path)); ?>"
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-sm-6 mb-2">
                            ...
                            <span class="text-muted"><?php echo e($approvalRequest->full_document_number); ?></span>
                        </div>
                        <div class="col-sm-6 mb-2">
                            <strong>Document Type:</strong><br>
                            <span class="text-muted"><?php echo e($approvalRequest->document_type ?? 'N/A'); ?></span>
                        </div>
                        <div class="col-sm-6 mb-2">
                            <strong>Submitted:</strong><br>
                            <span class="text-muted"><?php echo e($approvalRequest->created_at->format('d M Y H:i')); ?></span>
                        </div>
                    </div>
                </div>
    ...
    <div class="preview-modal-content" onclick="event.stopPropagation()">
        ...
        <div class="mt-3">
            ...
            <ul class="list-unstyled mt-2">
                <li><strong>Document:</strong> <?php echo e($approvalRequest->document_name); ?></li>
                <li><strong>Signer:</strong> <?php echo e($approvalRequest->approver->name); ?></li>
...
let placedQR = null;
let qrCodeImageSrc = "<?php echo e($documentSignature && $documentSignature->temporary_qr_code_path ? Storage::url($documentSignature->temporary_qr_code_path) : ''); ?>";

const approvalRequestId = <?php echo e($approvalRequest->id); ?>;
const documentPath = "<?php echo e(Storage::url($approvalRequest->document_path)); ?>";
...
async function signDocument() {
    ...
    try {
        ...
        if (data.success) {
            ...
            window.location.href = '<?php echo e(route("user.signature.approval.status")); ?>';
        } else {
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/porto-mac/Documents/GitHub/web-umt/resources/views/digital-signature/user/new2-sign-document.blade.php ENDPATH**/ ?>