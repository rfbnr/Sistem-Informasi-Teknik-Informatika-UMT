<?php $__env->startSection('title', 'Signature Key Details - ' . $key->signature_id); ?>
...
<div class="main-content">
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center">
                    <a href="<?php echo e(route('admin.signature.keys.index')); ?>" class="btn btn-outline-light me-3">
                    ...
                    <div>
                        ...
                        <p class="mb-0 opacity-75"><?php echo e($key->signature_id); ?></p>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-8 mb-4">
            <div class="card shadow-sm key-info-card status-<?php echo e($statusClass); ?>">
                ...
                <div class="card-body">
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <code class="text-primary"><?php echo e($key->signature_id); ?></code>
                                <i class="fas fa-copy copy-btn ms-2" onclick="copyToClipboard('<?php echo e($key->signature_id); ?>')" title="Copy ID"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8"><?php echo e($key->algorithm); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8"><?php echo e($key->key_length); ?> bits</div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-8">
                                <?php if($key->status == 'active'): ?>
                                    ...
                                    <?php elseif($daysUntilExpiry <= 7): ?>
                                        <span class="badge bg-danger">
                                            <i class="fas fa-clock"></i> URGENT - Expires in <?php echo e($daysUntilExpiry); ?> days
                                        </span>
                                    <?php elseif($daysUntilExpiry <= 30): ?>
                                        <span class="badge bg-warning">
                                            <i class="fas fa-exclamation-circle"></i> Expiring Soon (<?php echo e($daysUntilExpiry); ?> days)
                                        </span>
                                    <?php else: ?>
                    ...
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8"><?php echo e($key->valid_from->format('d F Y H:i:s')); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <?php echo e($key->valid_until->format('d F Y H:i:s')); ?>
                    ...
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <?php echo e($key->revoked_at ? $key->revoked_at->format('d F Y H:i:s') : 'N/A'); ?>
                    ...
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <span class="text-danger"><?php echo e($key->revocation_reason ?? 'N/A'); ?></span>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8"><?php echo e($key->created_at->format('d F Y H:i:s')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm mt-4">
                ...
                <div class="card-body">
                    <div class="fingerprint-box">
                        ...
                        <?php echo e($key->getPublicKeyFingerprint()); ?>

                    </div>
                    <div class="mt-3 d-flex gap-2">
                        <button class="btn btn-sm btn-primary" onclick="copyToClipboard('<?php echo e($key->getPublicKeyFingerprint()); ?>')">
                            <i class="fas fa-copy"></i> Copy Fingerprint
                        </button>
                        <a href="<?php echo e(route('admin.signature.keys.export.public', $key->id)); ?>" class="btn btn-sm btn-success">
                ...
                <div class="card-body">
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8"><?php echo e($key->documentSignature->approvalRequest->document_name); ?></div>
                        </div>
                    </div>
                    <div class="info-row">
                        <div class="row">
                            <div class="col-md-4"><strong>Document Type:</strong></div>
                            <div class="col-md-8"><?php echo e(ucfirst(str_replace('_', ' ', $key->documentSignature->approvalRequest->document_type))); ?></div>
                        </div>
                    </div>
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <?php echo e($key->documentSignature->approvalRequest->user->name ?? 'N/A'); ?>

                                (<?php echo e($key->documentSignature->approvalRequest->user->NIM ?? 'N/A'); ?>)
                            </div>
                        </div>
                    </div>
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8"><?php echo e($key->documentSignature->signer->name ?? 'N/A'); ?></div>
                        </div>
                    </div>
                    <div class="info-row">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <?php echo e($key->documentSignature->signed_at ? $key->documentSignature->signed_at->format('d F Y H:i:s') : 'Not signed yet'); ?>

                            </div>
                        </div>
                    </div>
                    <div class="mt-3">
                        <a href="<?php echo e(route('admin.signature.documents.show', $key->documentSignature->id)); ?>" class="btn btn-primary">
                ...
                <div class="card-body">
                    <div class="text-center mb-3">
                        <div class="display-6 text-primary">
                            <?php echo e($usageStats['total_verifications']); ?>
                    ...
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <div class="h4 text-success"><?php echo e($usageStats['successful_verifications']); ?></div>
                            <small class="text-muted">Successful</small>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="h4 text-info"><?php echo e($usageStats['verification_rate']); ?>%</div>
                            <small class="text-muted">Success Rate</small>
                        </div>
                    </div>

                    <?php if($usageStats['last_verification']): ?>
                    <div class="mt-3 p-2 bg-light rounded">
                        <small class="text-muted">Last Verification:</small><br>
                        <strong><?php echo e($usageStats['last_verification']->diffForHumans()); ?></strong>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <?php if($key->certificate): ?>
                        <button class="btn btn-primary" onclick="viewCertificate()">
                            <i class="fas fa-certificate"></i> View Certificate
                        </button>
                        <?php endif; ?>

                        <a href="<?php echo e(route('admin.signature.keys.export.public', $key->id)); ?>" class="btn btn-success">
                            <i class="fas fa-download"></i> Export Public Key
                        </a>

                        <a href="<?php echo e(route('admin.signature.keys.audit', $key->id)); ?>" class="btn btn-info">
...
<div class="modal fade" id="revokeModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('admin.signature.keys.revoke', $key->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <strong>Key ID:</strong> <?php echo e($key->signature_id); ?>
...
function viewCertificate() {
    ...
    fetch('<?php echo e(route('admin.signature.keys.certificate', $key->id)); ?>', {
        headers: {
...
<?php echo $__env->make('digital-signature.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/porto-mac/Documents/GitHub/web-umt/resources/views/digital-signature/admin/keys/show.blade.php ENDPATH**/ ?>