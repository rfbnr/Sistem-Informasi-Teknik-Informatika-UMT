        ...
        <div class="pdf-preview-section">
            ...
            <div class="document-header">
                <div class="document-title">
                    ...
                    <h4><?php echo e($approvalRequest->document_name); ?></h4>
                </div>

                <div class="document-info">
                    <div class="info-item">
                        <strong>Document Type</strong>
                        <span><?php echo e($approvalRequest->document_type ?? 'N/A'); ?></span>
                    </div>
                    <div class="info-item">
                        <strong>Submitted</strong>
                        <span><?php echo e($approvalRequest->created_at->format('d M Y H:i')); ?></span>
                    </div>
        ...
        <div class="preview-details">
            ...
            <ul>
                <li>
                    ...
                    <span><?php echo e($approvalRequest->document_name); ?></span>
                </li>
                <li>
                    <strong>Signer:</strong>
                    <span><?php echo e($approvalRequest->approver->name ?? 'N/A'); ?></span>
                </li>
                <li>
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/porto-mac/Documents/GitHub/web-umt/resources/views/digital-signature/user/new-sign-document.blade.php ENDPATH**/ ?>