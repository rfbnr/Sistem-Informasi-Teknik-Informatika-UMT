...
<head>
    ...
    <title>UMT | <?php echo $__env->yieldContent('title', 'Digital Signature System'); ?></title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container-fluid">
            ...
            <div class="navbar-nav ms-auto">
                <?php if(auth()->guard('kaprodi')->check()): ?>
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                            <i class="fas fa-user-shield me-1"></i>
                            <?php echo e(Auth::guard('kaprodi')->user()->name); ?>

                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.signature.dashboard')); ?>">
...
<?php /**PATH /Users/porto-mac/Documents/GitHub/web-umt/resources/views/digital-signature/layouts/app.blade.php ENDPATH**/ ?>