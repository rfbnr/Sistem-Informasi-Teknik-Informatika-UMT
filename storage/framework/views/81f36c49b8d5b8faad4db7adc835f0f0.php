<?php $__env->startSection('title', 'Audit Logs - Activity Logs'); ?>
...
<div class="main-content">
    ...
    <ul class="nav nav-tabs mb-4" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" href="<?php echo e(route('admin.signature.logs.audit')); ?>">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" href="<?php echo e(route('admin.signature.logs.verification')); ?>">
    ...
    <div class="filter-card">
        <form method="GET" action="<?php echo e(route('admin.signature.logs.audit')); ?>" id="filterForm">
            <div class="row g-3">
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <select name="action" class="form-select form-select-sm">
                        ...
                        <?php $__currentLoopData = $actionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value); ?>" <?php echo e($action == $value ? 'selected' : ''); ?>>
                                <?php echo e($label); ?>
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <select name="device" class="form-select form-select-sm">
                        ...
                        <option value="desktop" <?php echo e($device == 'desktop' ? 'selected' : ''); ?>>Desktop</option>
                        <option value="mobile" <?php echo e($device == 'mobile' ? 'selected' : ''); ?>>Mobile</option>
                        <option value="tablet" <?php echo e($device == 'tablet' ? 'selected' : ''); ?>>Tablet</option>
                    </select>
                </div>
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <select name="status" class="form-select form-select-sm">
                        ...
                        <option value="success" <?php echo e($status == 'success' ? 'selected' : ''); ?>>Success</option>
                ...
                <div class="col-lg-12">
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <a href="<?php echo e(route('admin.signature.logs.audit')); ?>" class="btn btn-light btn-sm">
                ...
                <ul class="timeline">
                    <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="timeline-item">
                            <!-- Timeline Icon -->
                            <div class="timeline-icon" style="background: <?php echo e($log->is_success ? '#28a745' : '#dc3545'); ?>; color: white;">
                                <i class="fas fa-<?php echo e($log->is_success ? 'check' : 'times'); ?>"></i>
                            </div>

                            <!-- Timeline Card -->
                            <div class="timeline-card <?php echo e($log->is_success ? 'success' : 'failed'); ?>">
                                <div class="timeline-header">
                                    <div>
                                        ...
                                        <p class="mb-0 small text-muted"><?php echo e($log->description); ?></p>
                                    </div>
                                    <div class="timeline-time">
                                        <i class="fas fa-clock me-1"></i>
                                        <?php echo e($log->performed_at->format('H:i:s')); ?>

                                        <br>
                                        <small class="text-muted"><?php echo e($log->performed_at->format('d M Y')); ?></small>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-meta">
                                    ...
                                    <?php if($log->duration_human): ?>
                                        <span class="meta-item">
                                            <i class="fas fa-stopwatch"></i>
                                            <?php echo e($log->duration_human); ?>
                                ...
                                <!-- View Details Button -->
                                <div class="mt-3">
                                    <button class="btn btn-sm btn-outline-primary" onclick="viewLogDetails(<?php echo e($log->id); ?>, 'audit')">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div class="empty-state">
                    ...
                    <a href="<?php echo e(route('admin.signature.logs.audit')); ?>" class="btn btn-primary mt-3">
...
<?php echo $__env->make('digital-signature.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/porto-mac/Documents/GitHub/web-umt/resources/views/digital-signature/admin/logs/audit.blade.php ENDPATH**/ ?>