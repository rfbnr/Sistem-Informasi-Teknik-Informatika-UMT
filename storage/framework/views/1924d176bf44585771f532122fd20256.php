        ...
        <tr>
            <td align="center">
                <h3 class="section-title">
                    <?php echo e($title ?? '🔍 Verifikasi Dokumen'); ?>
                ...
                <?php if(isset($qrCodeUrl)): ?>
                    <img src="<?php echo e($qrCodeUrl); ?>" alt="QR Code Verifikasi Url" style="max-width: 200px; margin: 15px auto; padding: 15px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); display: block;" />
                <?php elseif(isset($qrCodeBase64)): ?>
                    <img src="data:image/png;base64,<?php echo e($qrCodeBase64); ?>" alt="QR Code Verifikasi Base64" style="max-width: 200px; margin: 15px auto; padding: 15px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); display: block;" />
                <?php endif; ?>
                ...
                <?php if(isset($verificationUrl)): ?>
                <p class="mt-15 mb-0 text-muted text-tiny">
                    Atau klik link berikut untuk verifikasi manual:<br>
                    <a href="<?php echo e($verificationUrl); ?>" class="link-primary" style="font-weight: 600;">
                        Verifikasi Dokumen
                    </a>
                </p>
                <?php endif; ?>
...
<?php /**PATH /Users/porto-mac/Documents/GitHub/web-umt/resources/views/emails/components/qr-code.blade.php ENDPATH**/ ?>