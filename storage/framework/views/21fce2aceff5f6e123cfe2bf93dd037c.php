...
<head>
    ...
    <link href="<?php echo e(url('assets/logo.JPG')); ?>" rel="icon">
    <link href="<?php echo e(url('assets/logo.JPG')); ?>" rel="apple-touch-icon">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-xl-8">
                    <div class="result-card">
                        <!-- Header -->
                        <div class="result-header <?php echo e($verificationResult['is_valid'] ? 'valid' : 'invalid'); ?> justify-content-center d-flex flex-column align-items-center">
                            <img src="<?php echo e(asset('assets/logo.JPG')); ?>" alt="Logo UMT" class="university-logo">
                            ...
                            <div class="mt-3">
                                <small>Verifikasi ID: <?php echo e($verificationResult['verification_id']); ?></small><br>
                                <small><?php echo e($verificationResult['verified_at']->format('d F Y, H:i:s')); ?> WIB</small>
                            </div>
                        </div>

                        <!-- Body -->
                        <div class="result-body">
                            <?php if($verificationResult['is_valid'] && isset($verificationResult['details'])): ?>
                                <!-- Document Information -->
                                <?php if(isset($verificationResult['details']['approval_request'])): ?>
                                    <?php $document = $verificationResult['details']['approval_request']; ?>
                                    <div class="info-card ">
                                        <h5 class="mb-3">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                ...
                                                <?php echo e($document->document_type ?? 'Tidak diketahui'); ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <?php elseif($document->status === 'user_signed'): ?>
                                                    <span class="badge bg-info text-dark">Ditandatangani Pengguna</span>
                                                <?php elseif($document->status === 'sign_approved'): ?>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-6">
                                                ...
                                                <?php echo e($document->user->name ?? 'Tidak diketahui'); ?>

                                            </div>
                                            <div class="col-md-6">
                                                <strong>Tanggal Pengajuan:</strong><br>
                                                <?php echo e($document->created_at->format('d F Y')); ?>
                                ...
                                <?php if(isset($verificationResult['details']['document_signature'])): ?>
                                    <?php $signature = $verificationResult['details']['document_signature']; ?>
                                    <div class="info-card">
                                        <h5 class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <?php echo e($signature->signer->name ?? 'Tidak diketahui'); ?>

                                            </div>
                                            <div class="col-md-6">
                                                <strong>Tanggal Tanda Tangan:</strong><br>
                                                <?php echo e($signature->signed_at ? $signature->signed_at->format('d F Y, H:i:s') : 'Tidak diketahui'); ?>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-6">
                                                ...
                                                <span class="badge bg-info"><?php echo e($signature->digitalSignature->algorithm ?? 'Tidak diketahui'); ?></span>
                                            </div>
                                            <div class="col-md-6">
                                                <strong>Panjang Kunci:</strong><br>
                                                <span class="badge bg-success"><?php echo e($signature->digitalSignature->key_length ?? 'N/A'); ?> bit</span>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <!-- Verification Checks -->
                                <?php if(isset($verificationResult['details']['checks'])): ?>
                                    <div class="info-card">
                                        <h5 class="mb-3">
                                        ...
                                        <?php $__currentLoopData = $verificationResult['details']['checks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $checkName => $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="check-item <?php echo e($check['status'] ? 'success' : 'failed'); ?>">
                                                <div class="d-flex align-items-center">
                                                    <i class="fas <?php echo e($check['status'] ? 'fa-check-circle text-success' : 'fa-times-circle text-danger'); ?> me-2"></i>
                                                    <div class="flex-grow-1">
                                                        <strong><?php echo e(getCheckLabel($checkName)); ?></strong>
                                ...
                                <?php if(isset($verificationResult['details']['verification_summary'])): ?>
                                    <?php $summary = $verificationResult['details']['verification_summary']; ?>
                                    <div class="verification-details">
                                        <div class="detail-item">
                                            <span><strong>Status Keseluruhan</strong></span>
                                            <span class="badge <?php echo e($summary['overall_status'] === 'VALID' ? 'bg-success' : 'bg-danger'); ?>">
                                                <?php echo e($summary['overall_status']); ?>

                                            </span>
                                        </div>
                                        <div class="detail-item">
                                            <span>Pemeriksaan Berhasil</span>
                                            <span><?php echo e($summary['checks_passed']); ?> / <?php echo e($summary['total_checks']); ?></span>
                                        </div>
                                        <div class="detail-item">
                                            <span>Tingkat Keberhasilan</span>
                                            <span><?php echo e($summary['success_rate']); ?>%</span>
                                        </div>
                                    </div>
                                <?php endif; ?>

                                <!-- Warnings -->
                                <?php if(isset($verificationResult['details']['warnings']) && !empty($verificationResult['details']['warnings'])): ?>
                                    <div class="alert alert-warning mt-3">
                                        <h6><i class="fas fa-exclamation-triangle"></i> Peringatan:</h6>
                                        <ul class="mb-0">
                                            <?php $__currentLoopData = $verificationResult['details']['warnings']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warning): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php else: ?>
                                ...
                                <div class="alert alert-danger">
                                    ...
                                    <?php if(isset($verificationResult['details']['error_details'])): ?>
                                        <hr>
                                        <small class="text-muted">
                                            Detail: <?php echo e($verificationResult['details']['error_details']); ?>
                            ...
                            <div class="text-center mt-4 no-print">
                                <a href="<?php echo e(route('signature.verify.page')); ?>" class="btn btn-outline-secondary me-2">
    ...
    <script>
        ...
        function previewDocument() {
            <?php if($verificationResult['is_valid']): ?>
                ...
                const signedFileName = '<?php echo e($document->signed_document_path ? basename($document->signed_document_path) : "Not Signed Yet"); ?>';

                // Set title based on type
                titleSpan.textContent = 'Signed Document Preview';

                // Get document path
                const docPath = '<?php echo e($document->signed_document_path ? asset("storage/" . $document->signed_document_path) : ""); ?>';
        ...
        function viewCertificate() {
            <?php if($verificationResult['is_valid']): ?>
                ...
                const extractedToken = extractTokenFromUrl('<?php echo e(request()->verification_input); ?>');

                var token = '<?php echo e(request()->route('token') ?? ''); ?>';
                ...
                fetch(`<?php echo e(route('signature.certificate.view', '')); ?>/${token}`, {
                    headers: {
        ...
        function shareResult() {
            if (navigator.share) {
                navigator.share({
                    ...
                    text: 'Status: <?php echo e($verificationResult['is_valid'] ? 'Valid' : 'Invalid'); ?>',
...
<?php /**PATH /Users/porto-mac/Documents/GitHub/web-umt/resources/views/digital-signature/verification/result.blade.php ENDPATH**/ ?>