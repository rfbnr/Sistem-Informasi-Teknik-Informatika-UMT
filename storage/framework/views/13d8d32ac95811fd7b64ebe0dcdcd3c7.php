...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo e(asset('assets/css/signature-interface.css')); ?>" rel="stylesheet">
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="verification-card">
                        ...
                        <div class="verification-body">
                            ...
                            <!-- Verification Form -->
                            <form id="verificationForm" action="<?php echo e(route('signature.verify.public')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/porto-mac/Documents/GitHub/web-umt/resources/views/digital-signature/verification/index.blade.php ENDPATH**/ ?>