        ...
        <div class="error-card">
            ...
            <div class="error-body">
                <div class="error-details">
                    ...
                    <p class="mb-0"><?php echo e($message ?? 'Invalid or expired verification link'); ?></p>
                </div>
                ...
                <div class="btn-group-custom">
                    <a href="<?php echo e(route('signature.verify.page')); ?>" class="btn btn-primary">
                        <i class="fas fa-redo me-2"></i>
                        Try Again
<?php /**PATH /Users/porto-mac/Documents/GitHub/web-umt/resources/views/digital-signature/verification/error.blade.php ENDPATH**/ ?>