...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('signature_audit_logs', function (Blueprint $table) {
            ...
            $table->foreignId('user_id')->nullable(); // User yang melakukan aksi
            $table->foreignId('kaprodi_id')->nullable(); // FK ke users (kaprodi)
            ...
            $table->foreign('kaprodi_id')->references('id')->on('kaprodis')->onDelete('set null');
