...
@section('title', 'Digital Document Approval Request')
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="form-section">
                    ...
                    <form action="{{ route('approval-request.upload') }}" method="POST" enctype="multipart/form-data" id="approvalForm">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="user_nim"
                                       value="{{ auth()->user()->NIM ?? 'Not Set' }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                <input type="radio" class="btn-check" name="priority" id="priority-low" value="low" {{ old('priority', 'normal') == 'low' ? 'checked' : '' }}>
                                <label class="priority-badge low" for="priority-low">
                                    <i class="fas fa-circle me-1"></i> Low Priority
                                </label>

                                <input type="radio" class="btn-check" name="priority" id="priority-normal" value="normal" {{ old('priority', 'normal') == 'normal' ? 'checked' : '' }}>
                                <label class="priority-badge normal" for="priority-normal">
                                    <i class="fas fa-circle me-1"></i> Normal Priority
                                </label>

                                <input type="radio" class="btn-check" name="priority" id="priority-high" value="high" {{ old('priority') == 'high' ? 'checked' : '' }}>
                                <label class="priority-badge high" for="priority-high">
                                    <i class="fas fa-circle me-1"></i> High Priority
                                </label>

                                <input type="radio" class="btn-check" name="priority" id="priority-urgent" value="urgent" {{ old('priority') == 'urgent' ? 'checked' : '' }}>
                        ...
                        @if ($hasApprovalRequests)
                            <div class="mt-4 p-3 bg-light rounded">
                                ...
                                Check your <a href="{{ route('approval-request.status') }}" class="text-decoration-none">document status page</a>
            ...
            <div class="col-lg-4">
                ...
                <div class="recent-requests">
                    ...
                    <div class="request-card">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="text-end">
                                <span class="status-indicator status-{{ str_replace(' ', '_', strtolower($request->status)) }}"></span>
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('approval-request.status') }}" class="btn btn-outline-primary btn-sm">
                ...
                <div class="recent-requests">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('signature.verify.page') }}" class="btn btn-outline-info btn-sm">
