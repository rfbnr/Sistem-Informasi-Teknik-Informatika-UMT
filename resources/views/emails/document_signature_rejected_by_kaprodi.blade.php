...
@section('content')
    ...
    <div class="alert alert-warning">
        ...
        <p class="mt-10 mb-0">
            Kaprodi telah meninjau tanda tangan Anda pada dokumen <strong>{{ $approvalRequest->document_name }}</strong> dan meminta Anda untuk <strong>menandatangani ulang atau mengajukan ulang</strong> dokumen tersebut.
        </p>
    </div>
