        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('approval-request.status') }}">My Documents</a></li>
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td>{{ $approvalRequest->document_name }}</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Document Number:</td>
                                    <td>{{ $approvalRequest->full_document_number }}</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Submitted By:</td>
                                    <td>{{ $approvalRequest->user->name }}</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">Submission Date:</td>
                                    <td>{{ $approvalRequest->created_at->format('d F Y') }}</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-info">{{ $approvalRequest->status_label }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        @if($digitalSignature)
                                            <span class="badge badge-success">{{ $digitalSignature->algorithm }}</span>
                                        @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-primary">
                                            {{ $digitalSignature ? $digitalSignature->key_length . ' bits' : 'N/A' }}
                                        </span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div id="textInfoElement" class="position-absolute draggable-element"
                                ...
                                <div class="text-info-placeholder border border-dashed border-info p-2"
                                    ...
                                    <div class="small">
                                        ...
                                        <div class="mt-1">Tangerang, {{ now()->format('d F Y') }}</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row text-center">
                        <div class="col-6">
                            <div class="border-right">
                                <div class="h6 font-weight-bold text-primary">
                                    {{ $digitalSignature ? $digitalSignature->algorithm : 'N/A' }}
                                </div>
                        ...
                        <div class="col-6">
                            <div class="h6 font-weight-bold text-success">
                                {{ $digitalSignature ? $digitalSignature->key_length : 'N/A' }} bits
                            </div>
...
@push('styles')
<link rel="stylesheet" href="{{ asset('assets/css/signature-interface.css') }}">
<style>
.draggable-element {
    cursor: move;
...
@push('scripts')
<script src="{{ asset('assets/js/signature-canvas.js') }}"></script>
<script>
$(document).ready(function() {
    ...
    const signatureCanvas = new SignatureCanvas({
        ...
        digitalSignatureId: {{ $digitalSignature ? $digitalSignature->id : 'null' }},
