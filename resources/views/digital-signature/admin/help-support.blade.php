{{-- resources/views/digital-signature/admin/help-support.blade.php --}}
...
<div class="main-content">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <!-- Help Sections -->
            @foreach($helpSections as $section)
            <div class="help-card" id="{{ $section['id'] }}">
                <div class="help-card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="mb-0 opacity-90">{{ $section['description'] }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="quick-link-card" onclick="window.open('{{ route('signature.verify.page') }}', '_blank')">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="quick-link-card" onclick="window.location='{{ route('admin.signature.reports.index') }}'">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="quick-link-card" onclick="window.location='{{ route('admin.signature.logs.audit') }}'">
