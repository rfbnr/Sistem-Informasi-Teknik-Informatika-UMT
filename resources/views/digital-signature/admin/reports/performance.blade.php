{{-- resources/views/digital-signature/admin/reports/performance.blade.php --}}
...
<div class="main-content">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-end">
                <a href="{{ route('admin.signature.reports.index') }}" class="btn btn-outline-light">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.signature.reports.performance') }}" class="row g-3 align-items-end">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <div class="text-muted">
                        <small>
                            ...
                            Currently showing <strong>{{ ucfirst($period) }}</strong> performance metrics
                        </small>
                    </div>
                </div>
            </form>
                    ...
                    <div class="alert alert-info">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                @if($metrics['approval_speed']['average'] == '2.5 days')
                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        <div class="display-3 text-success mb-2">
                            {{ $metrics['signature_rate']['signature_rate'] }}%
                        </div>
                    ...
                    <div class="progress mb-4" style="height: 30px;">
                        <div class="progress-bar bg-success progress-bar-striped progress-bar-animated"
                             style="width: {{ $metrics['signature_rate']['signature_rate'] }}%">
                            <strong>{{ $metrics['signature_rate']['signature_rate'] }}%</strong>
                        </div>
                    </div>

                    <div class="row text-center">
                        <div class="col-6 border-end">
                            <div class="h3 text-primary">{{ number_format($metrics['signature_rate']['total_requests']) }}</div>
                            <small class="text-muted">Total Requests</small>
                        </div>
                        <div class="col-6">
                            <div class="h3 text-success">{{ number_format($metrics['signature_rate']['signed_documents']) }}</div>
                    ...
                    <div class="alert alert-{{ $metrics['signature_rate']['signature_rate'] >= 80 ? 'success' : ($metrics['signature_rate']['signature_rate'] >= 60 ? 'warning' : 'danger') }}">
                        <i class="fas fa-{{ $metrics['signature_rate']['signature_rate'] >= 80 ? 'check-circle' : 'exclamation-triangle' }} me-2"></i>
                        @if($metrics['signature_rate']['signature_rate'] >= 80)
                            <strong>Excellent!</strong> Your signature completion rate is above 80%.
                        @elseif($metrics['signature_rate']['signature_rate'] >= 60)
        ...
        <div class="col-lg-6 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-{{ strpos($metrics['completion_trend']['trend'], '+') !== false ? 'success' : 'warning' }}">
                        <i class="fas fa-{{ strpos($metrics['completion_trend']['trend'], '+') !== false ? 'thumbs-up' : 'info-circle' }} me-2"></i>
                        @if(strpos($metrics['completion_trend']['trend'], '+') !== false)
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary">{{ $metrics['approval_speed']['average'] }}</span></td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary">{{ $metrics['signature_rate']['signature_rate'] }}%</span></td>
                                    <td><span class="badge bg-success">≥ 85%</span></td>
                                    <td><span class="badge bg-info">80-90%</span></td>
                                    <td>
                                        @if($metrics['signature_rate']['signature_rate'] >= 85)
                                            <span class="badge bg-success">
                                                <i class="fas fa-check-circle"></i> Excellent
                                            </span>
                                        @elseif($metrics['signature_rate']['signature_rate'] >= 70)
                                            <span class="badge bg-warning">
                                    ...
                                    <td>
                                        <div class="progress">
                                            <div class="progress-bar bg-{{ $metrics['signature_rate']['signature_rate'] >= 85 ? 'success' : 'warning' }}"
                                                 style="width: {{ $metrics['signature_rate']['signature_rate'] }}%">
                                                {{ $metrics['signature_rate']['signature_rate'] }}%
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary">{{ $metrics['completion_trend']['trend'] }}</span></td>
                                    <td><span class="badge bg-success">≥ +5%</span></td>
                                    <td><span class="badge bg-info">+3% to +10%</span></td>
                                    <td>
                                        @if(str_replace(['%', '+'], '', $metrics['completion_trend']['trend']) >= 5)
                                            <span class="badge bg-success">
                                                <i class="fas fa-check-circle"></i> Excellent
                                            </span>
                                        @else
...
new Chart(trendCtx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [{{ $metrics['completion_trend']['last_month'] }}, {{ $metrics['completion_trend']['this_month'] }}],
