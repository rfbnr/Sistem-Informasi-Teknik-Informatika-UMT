{{-- resources/views/digital-signature/user/help-support.blade.php --}}
...
<div class="container-fluid py-4">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <!-- Help Sections -->
            @foreach($helpSections as $section)
            <div class="card border-0 shadow-sm mb-4" id="{{ $section['id'] }}">
                <div class="card-header text-white" style="background: linear-gradient(135deg, #{{ $section['color'] === 'primary' ? '4e73df' : ($section['color'] === 'success' ? '1cc88a' : ($section['color'] === 'info' ? '36b9cc' : ($section['color'] === 'warning' ? 'f6c23e' : ($section['color'] === 'danger' ? 'e74a3b' : '858796')))) }} 0%, #{{ $section['color'] === 'primary' ? '224abe' : ($section['color'] === 'success' ? '17a673' : ($section['color'] === 'info' ? '2c9faf' : ($section['color'] === 'warning' ? 'c69500' : ($section['color'] === 'danger' ? 'be2617' : '60616f')))) }} 100%);">
                    <div class="d-flex align-items-center p-2">
                        <div class="me-3" style="width: 40px; height: 40px; background: rgba(255,255,255,0.2); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                            <i class="fas fa-{{ $section['icon'] }} fa-lg"></i>
                        </div>
                        <div>
                            <h5 class="mb-0">{{ $section['title'] }}</h5>
                            <small class="opacity-90">{{ $section['description'] }}</small>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button {{ $loop->first ? '' : 'collapsed' }}"
                                        ...
                                        data-bs-target="#collapse{{ $loop->parent->index }}_{{ $loop->index }}"
                                        style="font-weight: 600;">
                                    <i class="fas fa-chevron-right me-2"></i>
                                    {{ $item['title'] }}
                                </button>
                            </h2>
                            <div id="collapse{{ $loop->parent->index }}_{{ $loop->index }}"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="card border-2" style="cursor: pointer; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#4e73df';" onmouseout="this.style.transform=''; this.style.borderColor='';" onclick="window.location='{{ route('user.signature.approval.request') }}'">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card border-2" style="cursor: pointer; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#1cc88a';" onmouseout="this.style.transform=''; this.style.borderColor='';" onclick="window.location='{{ route('user.signature.approval.status') }}'">
                                <div class="card-body text-center">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card border-2" style="cursor: pointer; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#36b9cc';" onmouseout="this.style.transform=''; this.style.borderColor='';" onclick="window.location='{{ route('user.signature.my.signatures.index') }}'">
                                <div class="card-body text-center">
